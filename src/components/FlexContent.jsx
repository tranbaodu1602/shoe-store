...
const FlexContent = ({
  ...
  return (
    <>
      ...
      >
        <div
          className="max-w-lg lg:max-w-none w-full md:text-center grid 
        items-center lg:justify-items-center"
        >
          ...
          >
            <button
              type="button"
              className="button-theme bg-slate-900 shadow-slate-900
        ...
        <div
          className=" flex items-center justify-center max-w-xl relative
