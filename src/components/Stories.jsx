              ...
              <SplideSlide key={i} className="mb-0.5">
                ...
                >
                  <div className="flex items-center justify-center">
                    ...
                    shadow-md shadow-slate-200 rounded-tl-lg rounded-tr-lg"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-center ps-4 w-full">
                    <a
                      href={val.url}
                      target="_blank"
                      role={"button"}
                      className="w-full bg-gradient-to-b from-slate-900
                     to-black shadow-md shadow-black  text-center text-slate-100 
                     py1.5 bottom-theme"
                    >
                      {val.btn}
                    </a>
