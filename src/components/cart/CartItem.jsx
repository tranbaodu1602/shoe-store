      ...
      <div className=" flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          ...
          >
            ...
            />
            <div
              className="absolute right-1 top-1  blur-theme-effect bg-white/80
            text-black text-xs px-1 rounded"
            >
              ${price}
            </div>
          </div>
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full">
              ...
              lg:text-xs w-7 h-6 lg:w-6 lg:h-5 flex items-center justify-center"
              >
                {cartQuantity}
              </div>
              <button
        ...
        <div className="grid items-center gap-">
          ...
          <div className="grid items-center justify-center">
            <button
              type="button"
              className="bg-theme-cart rounded p-1 lg:p-0.5 grid 
